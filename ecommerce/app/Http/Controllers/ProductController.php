...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // $image->store(public_path('images'), $imageName );

        $product->save();
        return redirect()->route('products.index')->with('success', 'Product created successfully.');

        // $product->image  =$request->file('image')->storeAs('public/images',$request->file('image')->getClientOriginalName());
        // $product->image  =$request->file('image')->storeAs('images',time().'.'. $request->file('image')->getClientOriginalExtension(), 'public');
    }
